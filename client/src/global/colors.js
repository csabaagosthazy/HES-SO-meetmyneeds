...
export const COLORS = {
  ...
  yellow: {
    essential: { background: "rgb(205, 156, 17)", foreground: "#000" },
    important: { background: "rgb(237, 185, 37)", foreground: "#000" },
  ...
  green: {
    essential: { background: "rgb(72, 162, 141)", foreground: "#000" },
    important: { background: "rgb(77, 173, 150)", foreground: "#000" },
  ...
  blue: {
    essential: { background: "rgb(14, 163, 216)", foreground: "#000" },
    important: { background: "rgb(83, 203, 244)", foreground: "#000" },
