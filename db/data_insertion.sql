...
('Im Moment brauche ich Informationen über **die aktuellen wissenschaftlichen Erkenntnisse über die Krankheit**', 2, NULL, NULL , 1, 5 , 3),
('Im Moment brauche ich Informationen über **das Diagnoseverfahren**', 3, NULL, NULL , 1, 5 , 3),
('Im Moment brauche ich Informationen über **die Betreuung einer Person mit Demenz**', 4, NULL, NULL , 1, 5 , 3),
('Im Moment brauche ich Informationen über **die Behandlungsmöglichkeiten** der Krankheit meiner angehörigen Person und dazu **wie man diese auswählt**', 5, NULL, NULL , 1, 6 , 3),
('Im Moment brauche ich Informationen **über die Medikamente**, die meine angehörige Person einnimmt und dazu, **wie sie diese einnehmen soll**', 6, NULL, NULL , 1, 6 , 3),
('Im Moment brauche ich Informationen über Dienste und Organisationen, die mich von der Betreuung oder Pflege meiner angehörigen Person entlasten können und darüber, wie ich diese Entlastung erhalten kann', 7, NULL, NULL , 1, 7 , 3),
('Im Moment brauche ich mehr Informationen über Dienste und Organisationen, die mich als betreuende∙r Angehörige∙r unterstützen können, und wie ich diese Unterstützung erhalten kann', 8, NULL, NULL , 1, 7 , 3),
('Im Moment brauche ich Informationen über Lebensorte für Menschen mit Demenz für eine Langzeitbetreuung', 9, NULL, NULL , 1, 7 , 3),
('Im Moment muss ich wissen, wie Gedächtnisprobleme bei meiner angehörigen Person erkannt werden können. Ich muss wissen, was diese verschlimmern kann, um Situationen, die ihr|ihm Schwierigkeiten bereiten, vorbeugen und bewältigen zu können.*', 10, NULL, NULL , 2, 8, 3),
('Im Moment muss ich wissen, wie die Schwierigkeiten meines|r Angehörigen bei täglichen Aktivitäten erkannt, vorausgesehen und bewältigt werden können', 11, NULL, NULL , 2, 8, 3),
('Im Moment muss ich wissen, wie Krisensituationen erkannt (plötzliche Veränderungen bei meiner erkrankten angehörigen Person, die auf ein ernsthaftes Problem hinweisen können) und bewältigt werden können mit Unterstützung von Gesundheitsdiensten', 12, NULL, NULL , 2, 8, 3),
('Im Moment muss ich wissen, wie ich für die Interessen meines|r erkrankten Angehörigen einstehen kann im Versorgungsnetz', 13, NULL, NULL , 2, 8, 3),
('Im Moment muss ich wissen, wie Schwierigkeiten meiner angehörigen Person im Zusammenhang mit der Krankheit erkannt, vorausgesehen und bewältigt werden können (Verhaltensauffälligkeiten oder Emotionen, Kommunikation, Beschäftigung) und wie diese dem Umfeld erklärt werden können', 14, NULL, NULL , 2, 8, 3),
('Im Moment möchte ich lernen, wie ich helfen kann und gleichzeitig zu mir selber Sorge tragen kann', 15, NULL, NULL , 2, 9, 3),
('Im Moment brauche ich jemand der zuhört, Verständnis und Beratung für die schwierigen Emotionen, die ich im Zusammenhang mit den krankheitsbedingten Verlusten meines|r Angehörigen und dem damit verbundenen Trauerprozess empfinde', 16, NULL, NULL , 3, 10, 3),
('Im Moment brauche ich jemand der zuhört, Verständnis und Beratung für die schwierigen Emotionen, die ich in meiner Rolle als betreuende∙r Angehörige∙r empfinde', 17, NULL, NULL , 3, 10, 3),
('Im Moment brauche Hilfe, um schnell Lösungen zu finden, damit ich mich weniger erschöpft fühle', 18, NULL, NULL , 3, 11, 3),
('Im Moment brauche ich Hilfe, um mich in meiner Rolle als betreuende∙r Angehörige∙r mehr wertgeschätzt zu fühlen', 19, NULL, NULL , 3, 11, 3),
('Im Moment brauche ich einen Austausch mit Personen, die eine ähnliche Situation erleben', 20, NULL, NULL , 3, 11, 3),
('Im Moment brauche ich Hilfe, damit mein Umfeld mehr präsent ist und mich emotional oder praktisch unterstützt', 21, NULL, NULL , 3, 12, 3),
('Im Moment brauche ich Hilfe, um Konflikte oder Spannungen, die im Zusammenhang stehen mit der Krankheit meiner angehörigen Person, in meinem Umfeld zu reduzieren', 22, NULL, NULL , 3, 12, 3),
('Im Moment brauche ich eine Möglichkeit, meine angehörige Person einer anderen Person oder einer Institution anvertrauen zu können, um Zeit für mich zu haben', 23, NULL, NULL , 3, 13, 3),
('Im Moment brauche ich eine Lösung für den Fall, wenn ich mich vorübergehend nicht mehr um meine∙n erkrankte∙n Angehörige∙n kümmern kann', 24, NULL, NULL , 3, 13, 3),
('Im Moment brauche ich Lösungen, um die Betreuung schnell zu reduzieren oder zu beenden, da ich erschöpft bin', 25, NULL, NULL , 3, 13, 3),
('Im Moment brauche ich jemanden, der die Pflege meines|r erkrankten Angehörigen übernimmt', 26, NULL, NULL , 3, 13, 3),
('Im Moment brauche ich jemandem, der praktische Aufgaben übernimmt', 27, NULL, NULL , 3, 14, 3),
('Im Moment brauche ich Hilfe, um die Sicherheit meines|r erkrankten Angehörigen zu gewährleisten', 28, NULL, NULL , 3, 14, 3),
('Im Moment brauche ich **finanzielle Unterstützung**', 29, NULL, NULL , 3, 15, 3),
('Im Moment brauche ich Hilfe, um meinen Finanzhaushalt im Gleichgewicht zu halten, im Zusammenhang mit den aktuellen Einschränkungen', 30, NULL, NULL , 3, 15, 3),
('Im Moment brauche ich Beratung, um Rechtsfragen im Zusammenhang mit der Krankheit meines|r Angehörigen zu klären', 31, NULL, NULL , 3, 15, 3),
('Im Moment brauche ich **eine Betreuung in Bezug auf meine körperlichen Gesundheitsprobleme**', 32, NULL, NULL , 4, 16, 3),
('Im Moment brauche ich **eine Betreuung in Bezug auf meine psychischen Probleme**', 33, NULL, NULL , 4, 17, 3),
('den Namen und das Stadium der Krankheit', NULL, NULL, 1, 1, null, 3),
('die Bedeutung von medizinischen Begriffen', NULL, NULL, 1, 1, null , 3),
('Ursachen, Symptome und Verlauf der Krankheit', NULL, NULL, 1, 1, null , 3),
('wo diese Art von Informationen zu finden sind', NULL, NULL, 2, 1, null , 3),
('Kenntnisse über die Ursachen und den Verlauf', NULL, NULL, 2, 1, null , 3),
('Ergebnisse über die Wirksamkeit von Behandlungen', NULL, NULL, 2, 1, null , 3),
('wen und wann konsultieren', NULL, NULL, 3, 1, null , 3),
('wie werden Untersuchungen durchgeführt', NULL, NULL, 3, 1, null , 3),
('was bedeuten die Ergebnisse', NULL, NULL, 3, 1, null , 3),
('wie soll man sich verhalten', NULL, NULL, 4, 1, null , 3),
('welche Faktoren können die Symptome verschlimmern', NULL, NULL, 4, 1, null , 3),
('wann sollte welche Fachperson konsultiert werden', NULL, NULL, 4, 1, null , 3),
('Medikamente', NULL, NULL, 5, 1, null , 3),
('kognitives Training', NULL, NULL, 5, 1, null , 3),
('psychosoziale Unterstützung', NULL, NULL, 5, 1, null , 3),
('Behandlungsmöglichkeiten auswählen', NULL, NULL, 5, 1, null , 3),
('positive Wirkung und mögliche Nebenwirkungen', NULL, NULL, 6, 1, null , 3),
('wann und wie lange sollen die Medikamente eingenommen werden', NULL, NULL, 6, 1, null , 3),
('wie kann ich meiner angehörigen Person bei der Einnahme helfen', NULL, NULL, 6, 1, null , 3),
('wer ausser mir könnte ihm|ihr bei der Einnahme der Medikamente helfen', NULL, NULL, 6, 1, null , 3),
('Haushaltshilfe oder Pflegedienste', NULL, NULL, 7, 1, null , 3),
('Transportdienste', NULL, NULL, 7, 1, null , 3),
('Tagesheime oder Nachtbetreuung', NULL, NULL, 7, 1, null , 3),
('Mahlzeitendienst', NULL, NULL, 7, 1, null , 3),
('Hilfsmittel, wie Medikamentendispenser oder Inkontinenzmaterial', NULL, NULL, 7, 1, null , 3),
('an wen kann man sich wenden, wie ist das Vorgehen und welche Bedingungen müssen erfüllt sein', NULL, NULL, 7, 1, null , 3),
('Inhalt und Kosten der Angebote, wie wird die Qualität gewährleistet', NULL, NULL, 7, 1, null , 3),
('Zuhören und Unterstützung', NULL, NULL, 8, 1, null , 3),
('Schulung im Umgang mit der Krankheit im Alltag', NULL, NULL, 8, 1, null , 3),
('Vermittlung bei Konflikten mit meinem Umfeld', NULL, NULL, 8, 1, null , 3),
('Unterstützung bei Entscheidungen, Abstand nehmen oder Bewältigung von Verlusten', NULL, NULL, 8, 1, null , 3),
('an wen kann man sich wenden, wie ist das Vorgehen und welche Bedingungen müssen erfüllt sein', NULL, NULL, 8, 1, null , 3),
('Inhalt und Kosten der Angebote, wie wird die Qualität gewährleistet', NULL, NULL, 8, 1, null , 3),
('auf Demenz spezialisierte oder nicht spezialisierte Pflegeheime', NULL, NULL, 9, 1, null , 3),
('Lebensorte, wie Alterswohnungen oder Alterswohngemeinschaften', NULL, NULL, 9, 1, null , 3),
('Spannungen bei Interaktionen, Stress oder Misserfolge erkennen und vermeiden', NULL, NULL, 10, 2, null , 3),
('erkennen, wenn körperliche Gesundheitsprobleme (z. B. Schmerzen oder Fieber) die Schwierigkeiten meines|r Angehörigen verschlimmern', NULL, NULL, 10, 2, null , 3),
('wissen, wie man Situationen anpassen oder reagieren kann, wenn mein∙e Angehörige∙r in Schwierigkeiten ist', NULL, NULL, 10, 2, null , 3),
('erkennen, wann er|sie Hilfe braucht, z. B. beim Zubereiten von Mahlzeiten, Kleider auswählen, an- oder ausziehen, Zähneputzen, Toilettengang', NULL, NULL, 11, 2, null , 3),
('wissen, wie ich ihn|sie respektvoll und effizient unterstützen kann und ihm|ihr dabei möglichst viel Autonomie belassen kann', NULL, NULL, 11, 2, null , 3),
('eine Krise erkennen und wissen wie man reagieren kann', NULL, NULL, 12, 2, null , 3),
('wissen, wann und welche Fachperson kontaktiert werden soll', NULL, NULL, 12, 2, null , 3),
('wissen, wie man Hilfe anfordern kann', NULL, NULL, 12, 2, null , 3),
('eine Vollmacht für medizinische Entscheidung einholen', NULL, NULL, 13, 2, null , 3),
('wissen, was für meine∙n Angehörige∙n wichtig ist in diesem Bereich', NULL, NULL, 13, 2, null , 3),
('sich bei Entscheidungen beteiligen können, die meine∙n erkrankte∙n Angehörige∙n betreffen und sich Gehör verschaffen', NULL, NULL, 13, 2, null , 3),
('bei schwierigen Verhaltensweisen wie Aggressivität, Unruhe, ablehnendes Verhalten gegenüber Hilfestellungen, Verlust von Interessen oder Verwirrtheit', NULL, NULL, 14, 2, null , 3),
('bei schwierigen Emotionen wie plötzliche Veränderungen der Stimmung, Angst oder Verzweiflung', NULL, NULL, 14, 2, null , 3),
('bei Spannungen aufgrund von Verständnisproblemen', NULL, NULL, 14, 2, null , 3),
('zu Aktivitäten/Beschäftigung, die der angehörigen Person Freude bereiten und keinen Stress oder Gefühle von Misserfolg verursachen', NULL, NULL, 14, 2, null , 3),
('bewältigen von negativen oder schmerzhaften Emotionen im Zusammenhang mit den Schwierigkeiten meiner angehörigen Person', NULL, NULL, 15, 2, null , 3),
('eigene Bedürfnisse und Grenzen erkennen und Wege finden, wie diese respektiert werden können', NULL, NULL, 15, 2, null , 3),
('wissen, wie ich in meinem Umfeld Hilfe finden und diese annehmen kann', NULL, NULL, 15, 2, null , 3),
('wissen, wie ich mich auf Veränderungen vorbereiten kann', NULL, NULL, 15, 2, null , 3),
('mir Zeit für Pausen einräumen, um neue Energie zu tanken', NULL, NULL, 15, 2, null , 3),
('eine Person, dir mir wertfrei und im Vertrauen zuhört, die versteht, wie ich mich fühle, wenn meine angehörige Person Fähigkeiten verliert, sie mir fremd vorkommt und sie von mir abhängig ist …', NULL, NULL, 16, 3, null , 3),
('Unterstützung, um zu verstehen, was für mich schwierig ist', NULL, NULL, 16, 3, null , 3),
('Beratung dazu, wie man den Trauerprozess am besten bewältigen kann', NULL, NULL, 16, 3, null, 3),
('eine Person, dir mir wertfrei und im Vertrauen zuhört, die versteht, wie ich mich fühlen kann, wenn ich mich zum Beispiel gefangen, isoliert oder nicht anerkannt fühle in meiner Rolle als betreuende∙r Angehörige∙r', NULL, NULL, 17, 3, null , 3),
('Unterstützung, um zu verstehen, was mich belastet', NULL, NULL, 17, 3, null , 3),
('Beratung dazu, wie ich es machen kann, um weniger zu leiden', NULL, NULL, 17, 3, null , 3),
('um mich weniger überlastet zu fühlen, weniger das Gefühl zu haben die Kontrolle über mein Leben zu verlieren oder mit den Nerven am Ende zu sein', NULL, NULL, 18, 3, null , 3),
('um weniger hin- und hergerissen zu sein zwischen meinen verschiedenen Verpflichtungen', NULL, NULL, 18, 3, null , 3),
('damit meine Fähigkeiten bezüglich der Unterstützung, die ich leiste, mehr anerkannt werden', NULL, NULL, 19, 3, null , 3),
('damit das, was ich für sie|ihn tue, mehr geschätzt wird oder damit ich mehr ermutigt werde', NULL, NULL, 19, 3, null , 3),
('damit ich erkennen kann, wenn mir mein Umfeld Zeichen von Wertschätzung und Anerkennung entgegenbringt', NULL, NULL, 19, 3, null , 3),
('mit anderen betreuenden Angehörigen über meine Situation sprechen', NULL, NULL, 20, 3, null , 3),
('Teil einer Gruppe sein mit Personen in ähnlichen Situationen', NULL, NULL, 20, 3, null , 3),
('meine Erfahrungen und Fähigkeiten anderen betreuenden Angehörigen weitergeben', NULL, NULL, 20, 3, null , 3),
('wissen, wer aus meinem Umfeld präsent sein könnte', NULL, NULL, 21, 3, null , 3),
('wissen, wer aus meinem Umfeld ein offenes Ohr und Verständnis bieten könnte', NULL, NULL, 21, 3, null , 3),
('wissen, wer aus meinem Umfeld praktische Unterstützung bieten könnte', NULL, NULL, 21, 3, null , 3),
('jemanden aus meinem Umfeld, um die notwendige Präsenz oder Unterstützung bitten zu können', NULL, NULL, 21, 3, null , 3),
('mich für die Präsenz oder die Unterstützung bedanken können', NULL, NULL, 21, 3, null , 3),
('Ursachen für Konflikte oder Spannungen verstehen', NULL, NULL, 22, 3, null , 3),
('mit meinem Umfeld konstruktiv über die Krankheit und ihre Auswirkungen sprechen können', NULL, NULL, 22, 3, null , 3),
('erklären können, wie man mit den Schwierigkeiten meines|r Angehörigen umgehen kann', NULL, NULL, 22, 3, null , 3),
('mit meinem Umfeld konstruktiv darüber sprechen können, was ich als betreuende∙r Angehörige∙r mache', NULL, NULL, 22, 3, null , 3),
('mit meinem Umfeld offen über meine Bedürfnisse nach Unterstützung sprechen können', NULL, NULL, 22, 3, null , 3),
('für ein paar Stunden', NULL, NULL, 23, 3, null , 3),
('für einen oder mehrere Tage jede Woche', NULL, NULL, 23, 3, null , 3),
('für eine oder mehrere Wochen', NULL, NULL, 23, 3, null , 3),
('wissen, an wen man sich wenden und wie man vorgehen kann', NULL, NULL, 24, 3, null , 3),
('auswählen können, wo und wie meine angehörige Person betreut wird', NULL, NULL, 24, 3, null , 3),
('wie kann man vorgehen', NULL, NULL, 25, 3, null , 3),
('was würde dies finanziell oder praktisch bedeuten', NULL, NULL, 25, 3, null , 3),
('entscheiden können, was für mich wichtig ist, wie die Nähe zur Institution oder die Art der Institution', NULL, NULL, 25, 3, null , 3),
('für die Pflege, die körperlich schwierig ist oder ich als unangenehm empfinde', NULL, NULL, 26, 3, null , 3),
('über die Hygiene meines|r Angehörigen', NULL, NULL, 26, 3, null , 3),
('über die Einnahme seiner|ihrer Medikamente', NULL, NULL, 26, 3, null , 3),
('Organisation und Koordination der Betreuung meiner angehörigen Person', NULL, NULL, 27, 3, null , 3),
('Haushalt, Einkaufen, Wäsche waschen oder Bügeln', NULL, NULL, 27, 3, null , 3),
('Mahlzeiten', NULL, NULL, 27, 3, null , 3),
('Gartenarbeit, Instandhaltung der Wohnung/des Hauses oder Haustiere', NULL, NULL, 27, 3, null , 3),
('Transport meines|r erkrankten Angehörigen', NULL, NULL, 27, 3, null , 3),
('administrative oder finanzielle Angelegenheiten meines|r erkrankten Angehörigen', NULL, NULL, 27, 3, null , 3),
('verhindern, dass er|sie das Haus verlässt und sich verirrt', NULL, NULL, 28, 3, null , 3),
('das Haus so einrichten, dass er|sie nicht stürzt, sich nicht in Gefahr bringt oder Schaden verursacht', NULL, NULL, 28, 3, null , 3),
('sicherstellen, dass er|sie ausreichend und ausgewogen isst und trinkt', NULL, NULL, 28, 3, null , 3),
('eine finanzielle Entschädigung erhalten können', NULL, NULL, 29, 3, null , 3),
('an meine finanziellen Ressourcen angepasste Dienstleistungen', NULL, NULL, 29, 3, null , 3),
('Ausreichend Rückvergütung erhalten für Leistungen', NULL, NULL, 29, 3, null , 3),
('mein Budget an meine finanzielle Situation anpassen, z. B. bei einer Reduktion der Arbeitszeit oder krankheitsbedingten Ausgaben', NULL, NULL, 30, 3, null , 3),
('wissen, wie man mit unerwarteten Ausgaben umgehen kann, die durch meine erkrankte angehörige Person versursacht sind, z. B. wenn er|sie Geld verliert oder Schäden verursacht', NULL, NULL, 30, 3, null , 3),
('Umgang mit Verträgen, die von meinem|r Angehörigen unterschrieben wurden', NULL, NULL, 31, 3, null , 3),
('Schutz meiner angehörigen Person, wenn sie den Wert des Geldes nicht mehr kennt und zu viel ausgibt', NULL, NULL, 31, 3, null , 3),
('Rechte und Pflichten meines|r Angehörigen in Bezug auf den Führerscheinentzug', NULL, NULL, 31, 3, null , 3),
('gesetzliche∙r Vertreter∙in werden (administrativ, therapeutisch...)', NULL, NULL, 31, 3, null , 3),
('Rechte und Pflichten meiner angehörigen Person und der Verwandten beim Eintritt in ein Pflegeheim kennen', NULL, NULL, 31, 3, null , 3),
('Durchführen von notwendigen Untersuchungen in Zusammenhang mit meinen körperlichen Gesundheitsproblemen', NULL, NULL, 32, 4, null , 3),
