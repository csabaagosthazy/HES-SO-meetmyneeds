...
('den Namen und das Stadium der Krankheit', 1, 3),
('die Bedeutung von medizinischen Begriffen', 1, 3),
('Ursachen, Symptome und Verlauf der Krankheit', 1, 3),
('wo diese Art von Informationen zu finden sind', 2, 3),
('Kenntnisse über die Ursachen und den Verlauf', 2, 3),
('Ergebnisse über die Wirksamkeit von Behandlungen', 2, 3),
('wen und wann konsultieren', 3, 3),
('wie werden Untersuchungen durchgeführt', 3, 3),
('was bedeuten die Ergebnisse', 3, 3),
('wie soll man sich verhalten', 4, 3),
('welche Faktoren können die Symptome verschlimmern', 4, 3),
('wann sollte welche Fachperson konsultiert werden', 4, 3),
('Medikamente', 5, 3),
('kognitives Training', 5, 3),
('psychosoziale Unterstützung', 5, 3),
('Behandlungsmöglichkeiten auswählen', 5, 3),
('positive Wirkung und mögliche Nebenwirkungen', 6, 3),
('wann und wie lange sollen die Medikamente eingenommen werden', 6, 3),
('wie kann ich meiner angehörigen Person bei der Einnahme helfen', 6, 3),
('wer ausser mir könnte ihm|ihr bei der Einnahme der Medikamente helfen', 6, 3),
('Haushaltshilfe oder Pflegedienste', 7, 3),
('Transportdienste', 7, 3),
('Tagesheime oder Nachtbetreuung', 7, 3),
('Mahlzeitendienst', 7, 3),
('Hilfsmittel, wie Medikamentendispenser oder Inkontinenzmaterial', 7, 3),
('an wen kann man sich wenden, wie ist das Vorgehen und welche Bedingungen müssen erfüllt sein', 7, 3),
('Inhalt und Kosten der Angebote, wie wird die Qualität gewährleistet', 7, 3),
('Zuhören und Unterstützung', 8, 3),
('Schulung im Umgang mit der Krankheit im Alltag', 8, 3),
('Vermittlung bei Konflikten mit meinem Umfeld', 8, 3),
('Unterstützung bei Entscheidungen, Abstand nehmen oder Bewältigung von Verlusten', 8, 3),
('an wen kann man sich wenden, wie ist das Vorgehen und welche Bedingungen müssen erfüllt sein', 8, 3),
('Inhalt und Kosten der Angebote, wie wird die Qualität gewährleistet', 8, 3),
('auf Demenz spezialisierte oder nicht spezialisierte Pflegeheime', 9, 3),
('Lebensorte, wie Alterswohnungen oder Alterswohngemeinschaften', 9, 3),
('Spannungen bei Interaktionen, Stress oder Misserfolge erkennen und vermeiden', 10, 3),
('erkennen, wenn körperliche Gesundheitsprobleme (z. B. Schmerzen oder Fieber) die Schwierigkeiten meines|r Angehörigen verschlimmern', 10, 3),
('wissen, wie man Situationen anpassen oder reagieren kann, wenn mein∙e Angehörige∙r in Schwierigkeiten ist', 10, 3),
('erkennen, wann er|sie Hilfe braucht, z. B. beim Zubereiten von Mahlzeiten, Kleider auswählen, an- oder ausziehen, Zähneputzen, Toilettengang', 11, 3),
('wissen, wie ich ihn|sie respektvoll und effizient unterstützen kann und ihm|ihr dabei möglichst viel Autonomie belassen kann', 11, 3),
('eine Krise erkennen und wissen wie man reagieren kann', 12, 3),
('wissen, wann und welche Fachperson kontaktiert werden soll', 12, 3),
('wissen, wie man Hilfe anfordern kann', 12, 3),
('eine Vollmacht für medizinische Entscheidung einholen', 13, 3),
('wissen, was für meine∙n Angehörige∙n wichtig ist in diesem Bereich', 13, 3),
('sich bei Entscheidungen beteiligen können, die meine∙n erkrankte∙n Angehörige∙n betreffen und sich Gehör verschaffen', 13, 3),
('bei schwierigen Verhaltensweisen wie Aggressivität, Unruhe, ablehnendes Verhalten gegenüber Hilfestellungen, Verlust von Interessen oder Verwirrtheit', 14, 3),
('bei schwierigen Emotionen wie plötzliche Veränderungen der Stimmung, Angst oder Verzweiflung', 14, 3),
('bei Spannungen aufgrund von Verständnisproblemen', 14, 3),
('zu Aktivitäten/Beschäftigung, die der angehörigen Person Freude bereiten und keinen Stress oder Gefühle von Misserfolg verursachen', 14, 3),
('bewältigen von negativen oder schmerzhaften Emotionen im Zusammenhang mit den Schwierigkeiten meiner angehörigen Person', 15, 3),
('eigene Bedürfnisse und Grenzen erkennen und Wege finden, wie diese respektiert werden können', 15, 3),
('wissen, wie ich in meinem Umfeld Hilfe finden und diese annehmen kann', 15, 3),
('wissen, wie ich mich auf Veränderungen vorbereiten kann', 15, 3),
('mir Zeit für Pausen einräumen, um neue Energie zu tanken', 15, 3),
('eine Person, dir mir wertfrei und im Vertrauen zuhört, die versteht, wie ich mich fühle, wenn meine angehörige Person Fähigkeiten verliert, sie mir fremd vorkommt und sie von mir abhängig ist …', 16, 3),
('Unterstützung, um zu verstehen, was für mich schwierig ist', 16, 3),
('Beratung dazu, wie man den Trauerprozess am besten bewältigen kann', 16, 3),
('eine Person, dir mir wertfrei und im Vertrauen zuhört, die versteht, wie ich mich fühlen kann, wenn ich mich zum Beispiel gefangen, isoliert oder nicht anerkannt fühle in meiner Rolle als betreuende∙r Angehörige∙r', 17, 3),
('Unterstützung, um zu verstehen, was mich belastet', 17, 3),
('Beratung dazu, wie ich es machen kann, um weniger zu leiden', 17, 3),
('um mich weniger überlastet zu fühlen, weniger das Gefühl zu haben die Kontrolle über mein Leben zu verlieren oder mit den Nerven am Ende zu sein', 18, 3),
('um weniger hin- und hergerissen zu sein zwischen meinen verschiedenen Verpflichtungen', 18, 3),
('damit meine Fähigkeiten bezüglich der Unterstützung, die ich leiste, mehr anerkannt werden', 19, 3),
('damit das, was ich für sie|ihn tue, mehr geschätzt wird oder damit ich mehr ermutigt werde', 19, 3),
('damit ich erkennen kann, wenn mir mein Umfeld Zeichen von Wertschätzung und Anerkennung entgegenbringt', 19, 3),
('mit anderen betreuenden Angehörigen über meine Situation sprechen', 20, 3),
('Teil einer Gruppe sein mit Personen in ähnlichen Situationen', 20, 3),
('meine Erfahrungen und Fähigkeiten anderen betreuenden Angehörigen weitergeben', 20, 3),
('wissen, wer aus meinem Umfeld präsent sein könnte', 21, 3),
('wissen, wer aus meinem Umfeld ein offenes Ohr und Verständnis bieten könnte', 21, 3),
('wissen, wer aus meinem Umfeld praktische Unterstützung bieten könnte', 21, 3),
('jemanden aus meinem Umfeld, um die notwendige Präsenz oder Unterstützung bitten zu können', 21, 3),
('mich für die Präsenz oder die Unterstützung bedanken können', 21, 3),
('Ursachen für Konflikte oder Spannungen verstehen', 22, 3),
('mit meinem Umfeld konstruktiv über die Krankheit und ihre Auswirkungen sprechen können', 22, 3),
('erklären können, wie man mit den Schwierigkeiten meines|r Angehörigen umgehen kann', 22, 3),
('mit meinem Umfeld konstruktiv darüber sprechen können, was ich als betreuende∙r Angehörige∙r mache', 22, 3),
('mit meinem Umfeld offen über meine Bedürfnisse nach Unterstützung sprechen können', 22, 3),
('für ein paar Stunden', 23, 3),
('für einen oder mehrere Tage jede Woche', 23, 3),
('für eine oder mehrere Wochen', 23, 3),
('wissen, an wen man sich wenden und wie man vorgehen kann', 24, 3),
('auswählen können, wo und wie meine angehörige Person betreut wird', 24, 3),
('wie kann man vorgehen', 25, 3),
('was würde dies finanziell oder praktisch bedeuten', 25, 3),
('entscheiden können, was für mich wichtig ist, wie die Nähe zur Institution oder die Art der Institution', 25, 3),
('für die Pflege, die körperlich schwierig ist oder ich als unangenehm empfinde', 26, 3),
('über die Hygiene meines|r Angehörigen', 26, 3),
('über die Einnahme seiner|ihrer Medikamente', 26, 3),
('Organisation und Koordination der Betreuung meiner angehörigen Person', 27, 3),
('Haushalt, Einkaufen, Wäsche waschen oder Bügeln', 27, 3),
('Mahlzeiten', 27, 3),
('Gartenarbeit, Instandhaltung der Wohnung/des Hauses oder Haustiere', 27, 3),
('Transport meines|r erkrankten Angehörigen', 27, 3),
('administrative oder finanzielle Angelegenheiten meines|r erkrankten Angehörigen', 27, 3),
('verhindern, dass er|sie das Haus verlässt und sich verirrt', 28, 3),
('das Haus so einrichten, dass er|sie nicht stürzt, sich nicht in Gefahr bringt oder Schaden verursacht', 28, 3),
('sicherstellen, dass er|sie ausreichend und ausgewogen isst und trinkt', 28, 3),
('eine finanzielle Entschädigung erhalten können', 29, 3),
('an meine finanziellen Ressourcen angepasste Dienstleistungen', 29, 3),
('Ausreichend Rückvergütung erhalten für Leistungen', 29, 3),
('mein Budget an meine finanzielle Situation anpassen, z. B. bei einer Reduktion der Arbeitszeit oder krankheitsbedingten Ausgaben', 30, 3),
('wissen, wie man mit unerwarteten Ausgaben umgehen kann, die durch meine erkrankte angehörige Person versursacht sind, z. B. wenn er|sie Geld verliert oder Schäden verursacht', 30, 3),
('Umgang mit Verträgen, die von meinem|r Angehörigen unterschrieben wurden', 31, 3),
('Schutz meiner angehörigen Person, wenn sie den Wert des Geldes nicht mehr kennt und zu viel ausgibt', 31, 3),
('Rechte und Pflichten meines|r Angehörigen in Bezug auf den Führerscheinentzug', 31, 3),
('gesetzliche∙r Vertreter∙in werden (administrativ, therapeutisch...)', 31, 3),
('Rechte und Pflichten meiner angehörigen Person und der Verwandten beim Eintritt in ein Pflegeheim kennen', 31, 3),
('Durchführen von notwendigen Untersuchungen in Zusammenhang mit meinen körperlichen Gesundheitsproblemen', 32, 3),
('eine medizinische Behandlung und die notwendige Nachsorge erhalten', 32, 3),
('Durchführung von notwendigen Evaluationen in Bezug auf meine psychischen Probleme, wie Depressionen, selbstverletzendes Verhalten, Erschöpfung, überwältigende Angstzustände oder extreme Reizbarkeit', 33, 3),
('eine medizinische Behandlung und die notwendige Nachsorge erhalten', 33, 3);
