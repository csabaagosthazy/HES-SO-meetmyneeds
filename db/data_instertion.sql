...
('Actuellement j’ai besoin d’informations sur **le diagnostic précis ou sur la maladie**', NULL, NULL, NULL, 1, 5 , 1),
('Actuellement j’ai besoin d’informations sur **les connaissances scientifiques actuelles qui concernent cette maladie**', NULL, NULL, NULL , 1, 5 , 1),
('Actuellement j’ai besoin d’informations **sur la procédure de diagnostic**', NULL, NULL, NULL , 1, 5 , 1),
('Actuellement j’ai besoin d’informations sur **l’accompagnement d’une personne avec démence**', NULL, NULL, NULL , 1, 5 , 1),
('Actuellement j’ai besoin d’informations **sur les traitements possibles** pour sa maladie et **sur comment choisir**', NULL, NULL, NULL , 1, 6 , 1),
('Actuellement j’ai besoin d’informations **sur les médicaments** que prend ma|mon proche, et **sur la manière de les prendre**', NULL, NULL, NULL , 1, 6 , 1),
('Actuellement j’ai besoin d’informations **sur les services et les organisations qui peuvent me décharger dans l’accompagnement ou les soins à ma|mon proche et sur comment obtenir ces décharges**', NULL, NULL, NULL , 1, 7 , 1),
('Actuellement j’ai besoin de plus d’informations **sur les services et les organisations qui peuvent me soutenir en tant que proche aidant∙e et sur comment obtenir ces soutiens**', NULL, NULL, NULL , 1, 7 , 1),
('Actuellement j’ai besoin d’informations **sur les lieux de vie à long terme pour personnes avec démence**', NULL, NULL, NULL , 1, 7 , 1),
('Actuellement j’ai besoin de savoir **reconnaître les problèmes de mémoire de ma|mon proche et ce qui peut les aggraver, pour anticiper et gérer les situations qui peuvent la|le mettre en difficulté**', NULL, NULL, NULL , 2, 8, 1),
('Actuellement j’ai besoin de savoir **reconnaître, anticiper et gérer les difficultés de ma|mon proche à gérer seul∙e ses activités quotidiennes**', NULL, NULL, NULL , 2, 8, 1),
('Actuellement j’ai besoin de savoir **reconnaître les situations de crise** (changements soudains chez ma|mon proche malade qui peuvent indiquer un problème sérieux), **et savoir comment les gérer en impliquant les services de santé**', NULL, NULL, NULL , 2, 8, 1),
('Actuellement j’ai besoin de savoir **défendre les intérêts de ma|mon proche malade face au réseau de prise en charge**', NULL, NULL, NULL , 2, 8, 1),
('Actuellement j’ai besoin de savoir **reconnaître, anticiper et gérer les difficultés de ma|mon proche liées à sa maladie** (comportements ou émotions, communication, occupations) **et de pouvoir les expliquer à mon entourage**', NULL, NULL, NULL , 2, 8, 1),
('Actuellement j’ai besoin d’**apprendre à aider tout en prenant soin de moi**', NULL, NULL, NULL , 2, 9, 1),
('Actuellement j’ai besoin d’**écoute, de compréhension et de conseils concernant les émotions difficiles que je ressens en lien avec les pertes dues à la maladie de ma|mon proche et le processus de deuil associé**', NULL, NULL, NULL , 3, 10, 1),
('Actuellement j’ai besoin d’**écoute, de compréhension et de conseils concernant les émotions difficiles que je ressens en lien avec mon rôle de proche aidant∙e**', NULL, NULL, NULL , 3, 10, 1),
('Actuellement j’ai besoin d’**aide pour trouver rapidement des solutions pour me sentir moins épuisé∙e**', NULL, NULL, NULL , 3, 11, 1),
('Actuellement j’ai besoin d’**aide pour me sentir plus valorisé∙e dans mon rôle de proche aidant∙e**', NULL, NULL, NULL , 3, 11, 1),
('Actuellement j’ai besoin d’**échanges et de partages avec des personnes vivant une situation similaire**', NULL, NULL, NULL , 3, 11, 1),
('Actuellement j’ai besoin d’**aide pour obtenir plus de présence et de soutien – émotionnel ou pratique – de mon entourage**', NULL, NULL, NULL , 3, 12, 1),
('Actuellement j’ai besoin d’**aide pour réduire les conflits ou les tensions avec mon entourage liés à la maladie de ma|mon proche**', NULL, NULL, NULL , 3, 12, 1),
('Actuellement j’ai besoin de **pouvoir confier ma|mon proche à une autre personne ou à une institution pour avoir du temps pour moi**', NULL, NULL, NULL , 3, 13, 1),
('Actuellement j’ai besoin de **trouver une solution au cas où je ne pourrais momentanément plus m’occuper de mon proche malade**', NULL, NULL, NULL , 3, 13, 1),
('Actuellement j’ai besoin de **solutions pour réduire ou arrêter rapidement l’accompagnement car je suis épuisé∙e**', NULL, NULL, NULL , 3, 13, 1),
('Actuellement j’ai besoin qu’**une personne me décharge des soins à donner à ma|mon proche malade**', NULL, NULL, NULL , 3, 13, 1),
('Actuellement j’ai besoin qu’**une personne me décharge de tâches pratiques**', NULL, NULL, NULL , 3, 14, 1),
('Actuellement j’ai besoin d’**aide pour veiller à la sécurité de ma|mon proche malade**', NULL, NULL, NULL , 3, 14, 1),
('Actuellement j’ai besoin d’**aide financière**', NULL, NULL, NULL , 3, 15, 1),
('Actuellement j’ai besoin d’**aide pour équilibrer mon budget en tenant compte de mes contraintes**', NULL, NULL, NULL , 3, 15, 1),
('Actuellement j’ai besoin de **conseils pour gérer les questions légales liées à la maladie de ma|mon proche**', NULL, NULL, NULL , 3, 15, 1),
('Actuellement j’ai besoin d’**une prise en charge de mes problèmes de santé physique**', NULL, NULL, NULL , 4, 16, 1),
('Actuellement j’ai besoin d’**une prise en charge de mes problèmes de santé mentale**', NULL, NULL, NULL , 4, 17, 1),
